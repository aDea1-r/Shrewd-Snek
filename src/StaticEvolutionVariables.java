public class StaticEvolutionVariables {
    ...
    static int timeOutTime = 267;           //Time in ticks it takes a snake to die from not eating

    //other stuff
    static double percentOldToKeep = 1/80.0;    //Percent of old generation to keep and mutate
    static int numTimesToRunGeneration = 1;     //Number of times each snake in each generation will run, averages fitness together
