public class StaticEvolutionVariables {
    ...
    static int maxTimeScoreMultiplier = 1;  //Maximum score possible for time, Ex: 1 makes max score slightly less than 1 apple
    ...
    static int numTimesToRunGeneration = 8;     //Number of times each snake in each generation will run, averages fitness together
